...
async function reloadOverview() {
  overview.value = await api.getOverview(docId, {
    page: overviewPage.value,
    size: overviewSize.value,
    status: overviewStatus.value || undefined,
  });
}
  ...
  <div v-loading="loading">
    ...
    <el-card style="margin-top: 16px" v-if="overview">
      <div style="display: flex; justify-content: space-between; align-items: center">
        <h3 style="margin: 0">上报纵览</h3>
        <el-button @click="onExportOverview">导出 Excel</el-button>
      </div>
      <el-progress :percentage="progress" :stroke-width="14" style="margin-top: 12px" />
      <div class="summary">
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 24px">
        ...
        <el-radio-group v-model="overviewStatus" @change="onStatusFilter" size="small">
          ...
          <el-radio-button value="SUBMITTED">准时已交</el-radio-button>
          <el-radio-button value="SUBMITTED_LATE">逾期已交</el-radio-button>
          <el-radio-button value="OVERDUE">逾期未交</el-radio-button>
      ...
      <el-pagination
        ...
        :page-size="overviewSize"
        :current-page="overviewPage"
        :page-sizes="[20, 50, 100]"
        style="margin-top: 16px; justify-content: flex-end; display: flex"
        @current-change="onOverviewPageChange"
